...
class FuelServiceEnabledGuard extends AutoRouteGuard {
  FuelServiceEnabledGuard(this.ref);

  Ref ref;

  @override
  void onNavigation(NavigationResolver resolver, StackRouter router) {
    if (getOrgService(ref.read(orgDetailsProvider), 'FUEL')?.kycStatus == 'APPROVED') {
      resolver.next(true);
    } else {
      Snackbar.error("Fuel Service is not enabled for this organisation");
