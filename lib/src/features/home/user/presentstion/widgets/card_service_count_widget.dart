...
class CardCountToggleWidget extends StatefulWidget {
  const CardCountToggleWidget({
    super.key,
    required this.title,
  ...
  final double? secondaryMaxLimitAmount;

  @override
  State<CardCountToggleWidget> createState() => _CardCountToggleWidgetState();
}

class _CardCountToggleWidgetState extends State<CardCountToggleWidget> {
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      bottom: -3,
                                      child: Text(
                                        widget.defaultMaxLimitAmount.toString(),
                                      ),
                                    ),
                                  ],
                                ),
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(widget.secondaryCardTitle!, style: AxleTextStyle.textFieldHeadingStyle),
                            const SizedBox(height: defaultPadding),
                            Row(
                              mainAxisSize: MainAxisSize.min,
                              mainAxisAlignment: MainAxisAlignment.start,
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: Stack(
                                    children: [
                                      Slider(
                                        value: _walletCurrentSliderValue,
                                        min: 0,
                                        max: widget.secondaryMaxLimitAmount!.toDouble(),
                                        label: _walletCurrentSliderValue.round().toString(),
                                        divisions: widget.secondaryMaxLimitAmount!.toInt(),
                                        onChanged: (double value) {
                                          setState(
                                            () {
                                              widget.secondaryLimitController?.text =
                                                  num.parse(value.toString()).toString();
                                ...
                                AxleTextField(
                                  ...
                                  validate: isToggleEnabled
                                      ...
                                      : null,
                                  onChange: (val) {
                                    if (num.parse(val) <= widget.secondaryMaxLimitAmount!.toDouble()) {
